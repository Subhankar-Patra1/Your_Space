    ...
    <div className="min-h-screen bg-[#050505] text-white overflow-hidden selection:bg-[#FF4F00]/30 selection:text-[#FF4F00]">
      ...
      <main className="relative z-10">
        ...
        <section className="w-full py-20 text-center relative overflow-hidden rounded-3xl border border-white/5 bg-white/[0.02] max-w-5xl mx-auto mb-20 px-4">
            ...
            <div className="mt-20 flex justify-center space-x-8 text-xs text-gray-600 uppercase tracking-widest relative z-10">
                <a className="hover:text-[#FF4F00] transition-colors cursor-pointer">Privacy</a>
                <a className="hover:text-[#FF4F00] transition-colors cursor-pointer">Terms</a>
                <a className="hover:text-[#FF4F00] transition-colors cursor-pointer">Twitter</a>
            </div>
        </section>
